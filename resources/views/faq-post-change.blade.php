              ...
              <form class="form-horizontal" method="POST" action="">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" name="question" id="inputEmail3" value="{{$data['question']}}" placeholder="Question">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" name="answer" id="inputPassword3" value="{{$data['answer']}}" placeholder="Answer">
