            ...
            <div class="card">
              <div class="card-header">
                ...
                <div style="text-align: right;">
                  <a id = "addNew-btn" href ="/add-new-faq">ADD NEW</a>
                </div>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table class="table table-bordered">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        <div id = "faq-btns">
                        <button class="btn btn-info"><a href="/faq-post-change?id={{$faq['id']}}&action=edit">Edit</a></button>
                      ...
                      <td>
                        <div id = "faq-btns">
                          ...
                          <button class="btn btn-info"><a href="/delete/{{$faq['id']}}">Delete</a></button>
                        </div>
                      </td>
                    </tr> 
                    @endforeach
